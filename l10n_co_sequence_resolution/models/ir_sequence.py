...
class IrSequence(models.Model):
    ...
    dian_type = fields.Selection(selection=[('computer_generated_invoice',
    ...
    def check_active_resolution(self):
        ...
        if sequence_id.use_dian_control:
            ...
            current_date = current_date.astimezone(to_zone).strftime(
                '%Y-%m-%d')
    ...
    def check_date_range_ids(self):
        ...
        msg4 = _(
            'The Number Next must be greater in one to Number To, to represent a '
            +
    ...
    def _next(self):
        ...
        date_ranges = self.date_range_ids.search([('active_resolution', '=',
                                                   True)])
