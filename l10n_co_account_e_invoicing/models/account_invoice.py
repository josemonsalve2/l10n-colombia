...
class AccountInvoice(models.Model):
        ...
        for invoice_id in self:
            ...
            if sequence_id.dian_type in ('e-invoicing', "e-support_document"):
                sequence_resolution = self.env['ir.sequence.date_range'].search([
                    ('sequence_id', '=', sequence_id.id), ('active_resolution', '=', True)])
    ...
    def _get_active_dian_resolution(self):
        msg = _("You do not have an active dian resolution, contact with your "
                "administrator.")
    ...
    def _get_invoice_lines(self):
        ...
        msg3 = _("Your product: '%s', has no reference price, contact with your "
                 "administrator.")
        msg4 = _("Your tax: '%s', has no e-invoicing tax group type, contact with your "
                 "administrator.")
        msg5 = _("Your withholding tax: '%s', has amount equal to zero (0), the "
                 "withholding taxes must have amount different to zero (0), contact "
                 "with your administrator.")
        msg6 = _("Your tax: '%s', has negative amount or an amount equal to zero (0), "
                 "the taxes must have an amount greater than zero (0), contact with "
                 "your administrator.")
        invoice_lines = {}
        count = 1
        ...
        for invoice_line in self.invoice_line_ids:
            ...
            invoice_lines[count]['StandardItemIdentification'] = (
            ...
            if '01' not in invoice_lines[count]['TaxesTotal']:
                ...
                invoice_lines[count]['TaxesTotal']['01']['taxes']['0.00']['base'] = (
                    invoice_line.price_subtotal)
            ...
            if '04' not in invoice_lines[count]['TaxesTotal']:
                ...
                invoice_lines[count]['TaxesTotal']['04']['taxes']['0.00']['base'] = (
                    invoice_line.price_subtotal)
            ...
            if '03' not in invoice_lines[count]['TaxesTotal']:
                ...
                invoice_lines[count]['TaxesTotal']['03']['taxes']['0.00']['base'] = (
                    invoice_line.price_subtotal)
    ...
    def set_dian_document_ApplicationResponse(self, application_response_type):
        ...
        for invoice_id in self:
            ...
            dian_document_id = (
                invoice_id.dian_document_ids.filtered(
