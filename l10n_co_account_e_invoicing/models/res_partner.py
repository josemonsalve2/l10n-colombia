...
class ResPartner(models.Model):
        ...
        if self.einvoicing_email:
            ...
            if match is None:
                raise ValidationError(
                    _("The field 'E-Invoicing Email' is not correctly filled.\n\n"
                      "Please add @ and dot (.)"))
    ...
    def _get_accounting_partner_party_values(self):
        ...
        if ((self.person_type == '1'
             and document_type_code not in ('31', '50')) or
        ...
        if ((self.is_einvoicing_agent in ('yes', 'not_but')
             or not self.is_einvoicing_agent) and not self.einvoicing_email):
